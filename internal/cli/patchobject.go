...
func initPatchObjectCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Short:   "Patch object",
		Long:    "Patch object",
		Example: "  cli patch-object --team-id e02892d8-39b6-4e01-bdd8-d193f25fde02 --object-type ai_chat_thread --object-id 7d5a55a1-6054-4e9e-86fa-b60e9a64e727 --body '{\"default\":{\"key\":\"<value>\"\x7d\x7d'",
		Args:    cobra.NoArgs,
		RunE:    runPatchObjectCmd,
		Aliases: []string{"po"},
		Annotations: map[string]string{
			"speakeasy_operation": "patchObject",
		},
	}
	...
	if err := flagutil.AnnotateBodyFields(cmd, patchObjectCmdMeta, "Body", "body"); err != nil {
		return fmt.Errorf("annotate body fields for patch-object: %w", err)
	}
...
func runPatchObjectCmd(cmd *cobra.Command, args []string) error {
	...
	if requested, _ := cmd.Flags().GetBool("schema"); requested {
		return usage.EmitBodySchema(cmd.OutOrStdout(), "patchObject")
	}
