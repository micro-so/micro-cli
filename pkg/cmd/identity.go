...
var identitiesCreate = cli.Command{
	Name:    "create",
	...
	Action:          handleIdentitiesCreate,
	HideHelpCommand: true,
}

var identitiesUpdate = cli.Command{
	Name:    "update",
...
var identitiesDelete = cli.Command{
	Name:    "delete",
...
func handleIdentitiesCreate(ctx context.Context, cmd *cli.Command) error {
	...
	params := micro.IdentityNewParams{
	...
	_, err = client.Identities.New(ctx, params, options...)
	if err != nil {
		return err
	}
...
func handleIdentitiesUpdate(ctx context.Context, cmd *cli.Command) error {
	client := micro.NewClient(getDefaultRequestOptions(cmd)...)
	unusedArgs := cmd.Args().Slice()
	...
	params := micro.IdentityUpdateParams{
		TeamID: micro.F(cmd.Value("team-id").(string)),
	}
	...
	return client.Identities.Update(
		ctx,
...
func handleIdentitiesList(ctx context.Context, cmd *cli.Command) error {
	client := micro.NewClient(getDefaultRequestOptions(cmd)...)
	unusedArgs := cmd.Args().Slice()
	...
	params := micro.IdentityListParams{
		TeamID: micro.F(cmd.Value("team-id").(string)),
	}
	...
	var res []byte
	options = append(options, option.WithResponseBodyInto(&res))
	_, err = client.Identities.List(ctx, params, options...)
	if err != nil {
		return err
	}
...
func handleIdentitiesDelete(ctx context.Context, cmd *cli.Command) error {
	client := micro.NewClient(getDefaultRequestOptions(cmd)...)
	unusedArgs := cmd.Args().Slice()
	if !cmd.IsSet("identity-id") && len(unusedArgs) > 0 {
		cmd.Set("identity-id", unusedArgs[0])
	...
	params := micro.IdentityDeleteParams{
		TeamID: micro.F(cmd.Value("team-id").(string)),
	}
	...
	return client.Identities.Delete(
		ctx,
		cmd.Value("identity-id").(string),
		params,
		options...,
...
func handleIdentitiesImport(ctx context.Context, cmd *cli.Command) error {
	client := micro.NewClient(getDefaultRequestOptions(cmd)...)
	unusedArgs := cmd.Args().Slice()
	...
	params := micro.IdentityImportParams{
		TeamID: micro.F(cmd.Value("team-id").(string)),
	}
	...
	var res []byte
	options = append(options, option.WithResponseBodyInto(&res))
	_, err = client.Identities.Import(ctx, params, options...)
	if err != nil {
		return err
	}
