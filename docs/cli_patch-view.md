...
```
  cli patch-view --team-id 71d03c6d-331f-4ab0-a736-ed919385894f --view-object-type organization --view-id da4fdf5f-2002-43d8-9307-719c29ea935e
```
...
* `cli patch-view --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `cli patch-view --schema` — the exact JSON Schema of the request body (all `$ref`s bundled)
* `cli patch-view --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
