...
```
  cli unpin-view-record --team-id 6503d82a-a518-4343-ac14-d6ec97fe5b2c --view-object-type document --view-id 15414dcd-d5c0-4917-ac31-2a81fc1c8285 --object-id 6653be40-78a4-4d1d-8358-7989174daeba
```
...
* `cli unpin-view-record --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `cli unpin-view-record --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
