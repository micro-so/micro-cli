...
```
  cli create-metadata-property-option --team-id 638bb81b-7e3c-4105-a7b3-b35949652b97 --object-type action --property-id e075c94a-7a24-4c9a-901c-f554ecee71f4 --type multiref_read_receipt --value <value>
```
...
* `cli create-metadata-property-option --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `cli create-metadata-property-option --schema` — the exact JSON Schema of the request body (all `$ref`s bundled)
* `cli create-metadata-property-option --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
