...
```
  cli get-grant --team-id a7c8db69-f631-4797-928a-3af1b86e627e --object-type organization --object-id 888a0c54-4d0a-4136-a6ae-bfb2987d2ed5
```
...
* `cli get-grant --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `cli get-grant --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
