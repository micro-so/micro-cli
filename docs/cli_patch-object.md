...
```
cli patch-object [flags]
```

### Examples

```
  cli patch-object --team-id e02892d8-39b6-4e01-bdd8-d193f25fde02 --object-type ai_chat_thread --object-id 7d5a55a1-6054-4e9e-86fa-b60e9a64e727 --body '{"default":{"key":"<value>"}}'
```
...
```
  ...
  -b, --body-param string                          JSON value (one of: { "default": object, ... } | { "list": object, ... })
  -h, --help                                       help for patch-object
...
* `cli patch-object --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `cli patch-object --schema` — the exact JSON Schema of the request body (all `$ref`s bundled)
* `cli patch-object --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
