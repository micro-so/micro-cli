...
```
  cli duplicate-object --team-id 32e05ddc-57d8-4b8e-8e51-79fd11575fd3 --object-type identity --object-id ff654d6c-99d3-44f2-b2af-83cb139c0e56
```
...
* `cli duplicate-object --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `cli duplicate-object --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
