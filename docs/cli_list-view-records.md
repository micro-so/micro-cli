...
```
  cli list-view-records --team-id 5f478bf6-b37b-450e-9850-7b22e98c2777 --view-object-type action --view-id 7872a70f-a77f-401e-8bea-203dc7aa1e06
```
...
* `cli list-view-records --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `cli list-view-records --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
