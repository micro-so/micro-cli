...
```
  cli list-objects --team-id 25f1d299-6309-41ac-8567-2758463e8183 --object-type event
```
...
* `cli list-objects --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `cli list-objects --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
