...
```
  cli get-metadata-properties-by-object-type --team-id ac306c5b-0e6e-40ac-9717-2cd3d2b051c3 --object-type ai_chat_thread
```
...
* `cli get-metadata-properties-by-object-type --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `cli get-metadata-properties-by-object-type --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
