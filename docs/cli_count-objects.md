...
```
  cli count-objects --team-id 334bc1a2-d093-4be8-8078-f7ef2fa13681 --object-type organization
```
...
* `cli count-objects --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `cli count-objects --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
