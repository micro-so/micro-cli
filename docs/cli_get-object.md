...
```
  cli get-object --team-id 8376e295-a8cf-4072-a303-3c75424a5f46 --object-type event --object-id 089a27e7-6fc9-4559-bfe1-0d332cda6b98
```
...
* `cli get-object --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `cli get-object --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
