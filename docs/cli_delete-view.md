...
```
  cli delete-view --team-id fad35233-f5c6-4e04-802c-f84eb6caa2a6 --view-object-type event --view-id ec8b9808-d964-43ef-b1eb-29e2b6a3a8ec
```
...
* `cli delete-view --usage` — this command's flags, defaults and env vars as machine-readable KDL
* `cli delete-view --dry-run` — preview the request without OS-keychain access or a network call (human preview on stderr)
