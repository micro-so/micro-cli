...
#   or
#   Invoke-WebRequest -Uri https://raw.githubusercontent.com/micro-so/micro-cli/main/scripts/install.ps1 -UseBasicParsing | Invoke-Expression
#
# Options:
